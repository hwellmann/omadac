...
public abstract class GridAbstractException extends Exception {
     ...
     */
    protected GridAbstractException(String msg) {
        super(msg);
    }
     ...
     */
    protected GridAbstractException(String msg, Throwable cause) {
        super(msg, cause);
    }
     ...
     */
    public GridAbstractException setData(int line, String file) {
        this.line = line;
        this.file = file;
    ...
    public String toString() {
        ...
        for (Throwable e = this; e != null; e = e.getCause()) {
            ...
            // Don't show documentation link for non-gridgain exceptions.
            if (e.getClass().getName().startsWith("org.gridgain") == true) {
                buf.append(">>> Documentation: http://wiki.gridgain.org").append(NL);
            }

            // Add source file and line if nested exception is ours too.
            if (e instanceof GridAbstractException == true) {
                GridAbstractException e1 = (GridAbstractException)e;

                // Don't pollute output with 'null's.
                if (e1.file != null) {
                    String filePath = null;
                    
                    // If file path is relative - add GRIDGAIN_HOME to it. 
                    if (e1.file.charAt(0) != '/' && e1.file.charAt(1) != ':') {
                        filePath = System.getProperty("GRIDGAIN_HOME") + System.getProperty("file.separator") + 
                            e1.file;
                    }
                    else {
                        filePath = e1.file;
                    ...
                    buf.append(">>> Location: ").append(filePath).append(':').append(e1.line).append(NL);
                }
            }
