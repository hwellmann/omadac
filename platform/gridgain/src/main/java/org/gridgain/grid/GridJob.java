 ...
 * GridGain comes with convenience {@link GridJobAdapter} adapter that provides
 ...
 * point at the beginning of execution. If a <tt>non-null</tt> value is returned,
...
public interface GridJob extends Serializable {
     ...
     * {@link Thread#interrupt()}  method, it is really upto the actual job
     ...
     * Executes this job.
     *
     * @return Job execution result (possibly <tt>null</tt>). This result will be returned
