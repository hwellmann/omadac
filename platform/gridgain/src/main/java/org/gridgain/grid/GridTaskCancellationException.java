...
public class GridTaskCancellationException extends GridException {
    /**
     * Creates new task cancellation exception with given error message.
     *
     * @param msg Error message.
     */
    public GridTaskCancellationException(String msg) {
        super(msg);
    }
     ...
     */
    public GridTaskCancellationException(Throwable cause) {
     ...
     */
    public GridTaskCancellationException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
