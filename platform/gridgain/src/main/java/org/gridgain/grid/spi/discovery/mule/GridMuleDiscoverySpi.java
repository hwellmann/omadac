...
public class GridMuleDiscoverySpi extends GridSpiAdapter implements GridDiscoverySpi, GridMuleDiscoverySpiMBean {
    ...
    /** Discovery Mule component. */
    private GridMuleDiscoveryComponent muleComponent = null;
    ...
    public GridNode getNode(UUID nodeId) {
        assert nodeId != null : "ASSERTION [line=484, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
    ...
    public void spiStart(String gridName) throws GridSpiException {
        ...
        if (MuleManager.isInstanciated() == true) {
            ...
            if (cfgUrl != null) {
                try {
                    ...
                    throw (GridSpiException)new GridSpiException("Failed to download configuration file: " + cfgUrl, e).setData(559, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
                }
            }
            else {
            ...
            if (cfgPath == null || cfgPath.isDirectory() == true) {
                throw (GridSpiException)new GridSpiException("Invalid Mule configuration file path: " + cfgPath).setData(569, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
            }

            if (cfgPath.canRead() == false) {
                throw (GridSpiException)new GridSpiException("Mule configuration file does not have read permission: " + cfgPath).setData(573, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
            }

            try {
                MuleXmlConfigurationBuilder builder = new MuleXmlConfigurationBuilder();

                muleMgr = builder.configure(cfgPath.getAbsolutePath());
            }
            catch (ConfigurationException e) {
                throw (GridSpiException)new GridSpiException("Filed to start Mule manager.", e).setData(582, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
            }
        ...
        try {
            ...
            throw (GridSpiException)new GridSpiException("Filed to start Mule client.", e).setData(592, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }

        // Initialize component and all related data.
        initializeComponent();

        assert handshakeUri != null : "ASSERTION [line=598, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
        assert heartbeatUri != null : "ASSERTION [line=599, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
        ...
        try {
            ...
            throw (GridSpiException)new GridSpiException("Got interrupted during start.", e).setData(626, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }
    ...
    public void spiStop() throws GridSpiException {
        ...
        if (MuleManager.isInstanciated() == true && stopMule == true) {
            ...
            assert MuleManager.isInstanciated() == false : "ASSERTION [line=656, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
        }
    ...
    public boolean pingNode(UUID nodeId) {
        assert nodeId != null : "ASSERTION [line=679, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
        ...
        try {
            ...
            muleClient.dispatch(node.getHandshakeUri(), GridMarshalHelper.marshal(marshaller, request).getArray(),
                null);
    ...
    private void initializeComponent() throws GridSpiException {
        assert muleMgr != null : "ASSERTION [line=770, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";

        UMOComponent umo = muleMgr.getModel().getComponent(umoName);

        if (umo == null) {
            throw (GridSpiException)new GridSpiException("Failed to get Mule UMO component with name: " + umoName).setData(775, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }
        ...
        try {
            ...
            if (instance instanceof GridMuleDiscoveryComponent == false) {
                ...
                (instance == null ? null : instance.getClass().getName())).setData(782, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
            }

            muleComponent = (GridMuleDiscoveryComponent)instance;
        }
        catch (UMOException e) {
            throw (GridSpiException)new GridSpiException("Failed to get component instance to check component type.", e).setData(789, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }

        UMOInboundMessageRouter inRouter = umo.getDescriptor().getInboundRouter();

        if (inRouter == null) {
            throw (GridSpiException)new GridSpiException("Failed to get inbound router.").setData(795, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }

        List<UMOEndpoint> endpoints = inRouter.getEndpoints();

        if (endpoints == null || endpoints.size() == 0) {
            throw (GridSpiException)new GridSpiException("Failed to get inbound endpoints.").setData(801, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }
        ...
        if (props == null || props.isEmpty() == true || props.get(HANDSHAKE_ENDPOINT_NAME) == null ||
            ...
            throw (GridSpiException)new GridSpiException("Failed to get discovery inbound endpoint identifiers.").setData(808, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }

        // Get handshake inbound endpoint by name.
        UMOEndpoint inEndpoint = inRouter.getEndpoint((String)props.get(HANDSHAKE_ENDPOINT_NAME));

        if (inEndpoint == null) {
            throw (GridSpiException)new GridSpiException("Failed to get discovery handshake inbound endpoint by name: " +
                props.get(HANDSHAKE_ENDPOINT_NAME)).setData(815, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }

        handshakeUri = inEndpoint.getEndpointURI().toString();

        // Get heartbeat inbound endpoint by name.
        inEndpoint = inRouter.getEndpoint((String)props.get(HEARTBEAT_ENDPOINT_NAME));

        if (inEndpoint == null) {
            throw (GridSpiException)new GridSpiException("Failed to get discovery heartbeat inbound endpoint by name: " +
                props.get(HEARTBEAT_ENDPOINT_NAME)).setData(825, "src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java");
        }

        heartbeatUri = inEndpoint.getEndpointURI().toString();

        // Add SPI listener in component.
        muleComponent.setListener(new GridMuleDiscoveryComponentListener() {
            /**
             * {@inheritDoc}
             */
    ...
    private void notifyDiscovery(GridDiscoveryEventType type, GridMuleDiscoveryNode node) {
        assert type != null : "ASSERTION [line=869, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
        assert node != null : "ASSERTION [line=870, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
     ...
     * @throws UMOException Thrown in case of any Mule error.
     * @throws GridException Thrown in case of any error.
     */
    private void processHeartbeat(GridMuleDiscoveryHeartbeat beat) throws UMOException, GridException {
        assert beat != null : "ASSERTION [line=889, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
     ...
     * @throws UMOException Thrown in case of any Mule error.
     */
    private void processMessage(GridMuleDiscoveryMessage msg) throws GridException, UMOException {
        assert msg != null : "ASSERTION [line=1006, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
        ...
        switch (msg.getType()) {
            ...
            case HANDSHAKE_RESPONSE: {
                ...
                if (notify == true) {
                    assert node != null : "ASSERTION [line=1109, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
            ...
            default: { assert false : "Received message with unknown message type [msg=" + msg + ']'; }
        }
    }
    ...
    private class HeartbeatSender extends GridSpiThread {
        ...
        HeartbeatSender(String uri) {
            ...
            assert uri != null : "ASSERTION [line=1178, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
            assert muleClient != null : "ASSERTION [line=1179, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoverySpi.java]";
