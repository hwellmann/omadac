...
class GridMuleCommunicationMessage implements Serializable {
    ...
    GridMuleCommunicationMessage(UUID nodeId, Serializable msg) {
        assert nodeId != null : "ASSERTION [line=48, file=src/java/org/gridgain/grid/spi/communication/mule2/GridMuleCommunicationMessage.java]";
        assert msg != null : "ASSERTION [line=49, file=src/java/org/gridgain/grid/spi/communication/mule2/GridMuleCommunicationMessage.java]";
