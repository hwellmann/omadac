...
class GridMuleDiscoveryMessage implements Serializable {
    ...
    GridMuleDiscoveryMessage(UUID fromId, UUID toId, GridMuleDiscoveryMessageType type, Map<String,
        ...
        assert fromId != null : "ASSERTION [line=70, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryMessage.java]";
        assert toId != null : "ASSERTION [line=71, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryMessage.java]";
        assert type != null : "ASSERTION [line=72, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryMessage.java]";
        assert startTime > 0 : "ASSERTION [line=73, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryMessage.java]";
        assert handshakeUri != null : "ASSERTION [line=74, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryMessage.java]";
