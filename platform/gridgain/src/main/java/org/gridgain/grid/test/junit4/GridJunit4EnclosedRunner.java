...
class GridJunit4EnclosedRunner extends GridJunit4SuiteRunner {
    ...
    protected List<GridJunit4Runner> createChildren() {
        ...
        try {
            ...
            throw (GridRuntimeException)new GridRuntimeException("Failed to create children.", e).setData(56, "src/java/org/gridgain/grid/test/junit4/GridJunit4EnclosedRunner.java");
        }
