...
public class GridifyAspectJAspect {
    ...
    public Object gridify(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        assert ann != null : "ASSERTION [line=61, file=src/java/org/gridgain/grid/gridify/aop/aspectj/GridifyAspectJAspect.java]. " + "Intercepted method does not have gridify annotation.";
        ...
        if (GridFactory.getState(gridName) != GridFactoryState.STARTED) {
            throw (GridException)new GridException("Grid is not locally started: " + gridName).setData(72, "src/java/org/gridgain/grid/gridify/aop/aspectj/GridifyAspectJAspect.java");
        }
        ...
        if (ann.taskClass().equals(GridifyDefaultTask.class) == false && ann.taskName().length() > 0) {
            throw (GridException)new GridException("Gridify annotation must specify either Gridify.taskName() or " +
                "Gridify.taskClass(), but not both: " + ann).setData(87, "src/java/org/gridgain/grid/gridify/aop/aspectj/GridifyAspectJAspect.java");
        }
        ...
        try {
            ...
            throw (GridifyRuntimeException)new GridifyRuntimeException("Undeclared exception thrown: " + e.getMessage(), e).setData(128, "src/java/org/gridgain/grid/gridify/aop/aspectj/GridifyAspectJAspect.java");
        }
    }
}
