...
class GridMuleDiscoveryNode implements GridNode {
    ...
    /** Node attributes. */
    @GridToStringExclude
    private Map<String, ? extends Serializable> attrs = null;
    ...
    GridMuleDiscoveryNode(UUID id, long startTime, GridMuleDiscoveryNodeState state, String handshakeUri,
        ...
        assert id != null : "ASSERTION [line=80, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert startTime > 0 : "ASSERTION [line=81, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert state != null : "ASSERTION [line=82, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert handshakeUri != null : "ASSERTION [line=83, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert metrics != null : "ASSERTION [line=84, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
    ...
    GridMuleDiscoveryNode(UUID id, long startTime, GridMuleDiscoveryNodeState state, String handshakeUri,
        ...
        assert id != null : "ASSERTION [line=106, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert startTime > 0 : "ASSERTION [line=107, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert state != null : "ASSERTION [line=108, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert handshakeUri != null : "ASSERTION [line=109, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert metricsProvider != null : "ASSERTION [line=110, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
    ...
    GridMuleDiscoveryNode(UUID id, long startTime, GridMuleDiscoveryNodeState state, Map<String,
        ...
        assert id != null : "ASSERTION [line=131, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert startTime > 0 : "ASSERTION [line=132, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert state != null : "ASSERTION [line=133, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert attrs != null : "ASSERTION [line=134, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert handshakeUri != null : "ASSERTION [line=135, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
        assert metrics != null : "ASSERTION [line=136, file=src/java/org/gridgain/grid/spi/discovery/mule2/GridMuleDiscoveryNode.java]";
    ...
    public <T extends Serializable> Map<String, T> getAttributes() {
        synchronized (mux) {
            return (Map<String,T>)new HashMap<String, Serializable>(attrs);
        }
    }
