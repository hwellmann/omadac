...
class GridMuleDiscoveryHeartbeat implements Serializable {
    ...
    GridMuleDiscoveryHeartbeat(UUID nodeId, String handshakeUri, long startTime) {
        assert nodeId != null : "ASSERTION [line=62, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoveryHeartbeat.java]";
        assert handshakeUri != null : "ASSERTION [line=63, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoveryHeartbeat.java]";
        assert startTime > 0 : "ASSERTION [line=64, file=src/java/org/gridgain/grid/spi/discovery/mule/GridMuleDiscoveryHeartbeat.java]";
