...
class GridCoherenceCommunicationInfoAgent extends AbstractInvocable {
    ...
    GridCoherenceCommunicationInfoAgent(UUID srcNodeId) {
        assert srcNodeId != null : "ASSERTION [line=48, file=src/java/org/gridgain/grid/spi/communication/coherence/GridCoherenceCommunicationInfoAgent.java]";
    ...
    public String toString() {
        return GridToStringBuilder.toString(GridCoherenceCommunicationInfoAgent.class, this);
    }
}
