 ...
 * @version 2.1.1
 */
class GridUriDeploymentFtpException extends GridAbstractException {
    /**
     * Creates new grid exception with given error message.
     *
     * @param msg Error message.
     */
    GridUriDeploymentFtpException(String msg) {
        super(msg);
    }
     ...
     */
    GridUriDeploymentFtpException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
